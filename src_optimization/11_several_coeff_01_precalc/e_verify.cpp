...
int main()
{
    ...
    VALUE_TYPE *l_y_precalc = new VALUE_TYPE[OBJ_CELLS];
    ...
    std::cout << std::endl;
    std::cout << "> precalc:apply()" << std::endl;
    CLinearStencilPrecalc<VALUE_TYPE,VEC_TYPE> l_precalc(
        OBJ_COLS,
        OBJ_ROWS,
        OBJ_LEVELS,
        l_c,
    ...
    l_precalc.apply(l_x,l_y_precalc);
    ...
    std::cout << std::endl;
    std::cout << "> compare l_y_current with l_y_precalc" << std::endl;
    assert(equal(l_y_current, l_y_precalc) == true);
