...
class CLinearStencilPara : public ILinearOperator<ValueType>
{
 private:
 ...
 public:
    CLinearStencilPara(
      ...
      inline static const std::string IDENTIFER = "linear_stencil_para";
    void apply(const ValueType * __restrict__ p_x, ValueType * __restrict__ p_y) const;
    ~CLinearStencilPara();
};

template <typename ValueType, typename VecType>
CLinearStencilPara<ValueType, VecType>::CLinearStencilPara(
   const std::size_t p_objCols,
   const std::size_t p_objRows,
   const std::size_t p_objLevels,
   const ValueType p_c,
...
template <typename ValueType, typename VecType>
void CLinearStencilPara<ValueType, VecType>::apply(const ValueType * __restrict__ p_x, ValueType * __restrict__ p_y) const
{
   //---------------------------------------------------------------
   // Notes: corners
   //---------------------------------------------------------------
