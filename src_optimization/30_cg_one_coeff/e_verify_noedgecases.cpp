...
constexpr std::size_t OBJ_LEVELS_TILING = 16;
constexpr std::size_t OBJ_ROWS_TILING = 16;
constexpr std::size_t OBJ_COLS_TILING = 16;
...
#include "c_linear_stencil_noedgecases.hpp"
#include "c_linear_stencil_noedgecases_tiling.hpp"
...
int main()
{
    ...
    VALUE_TYPE *l_y_noedgecases = new VALUE_TYPE[OBJ_CELLS];
    VALUE_TYPE *l_y_noedgecases_tiling = new VALUE_TYPE[OBJ_CELLS];
    ...
    std::cout << std::endl;
    std::cout << "> noedgecases::apply()" << std::endl;
    CLinearStencilNoedgecases<VALUE_TYPE,VEC_TYPE> l_noedgecases(
        OBJ_COLS,
        OBJ_ROWS,
        OBJ_LEVELS,
        C,
    ...
    l_noedgecases.apply(l_x,l_y_noedgecases);

    // -------------------------------------------------------------------------------------------------

    std::cout << std::endl;
    std::cout << "> noedgecases:tiling::apply()" << std::endl;
    CLinearStencilNoedgecasesTiling<VALUE_TYPE,VEC_TYPE> l_noedgecases_tiling(
        OBJ_COLS,
        OBJ_ROWS,
        OBJ_LEVELS,
        OBJ_COLS_TILING,
    ...
    l_noedgecases_tiling.apply(l_x,l_y_noedgecases_tiling);
    ...
    std::cout << std::endl;
    std::cout << "> compare l_y_noedgecases with l_y_noedgecases_tiling" << std::endl;
    assert(equal(l_y_noedgecases, l_y_noedgecases_tiling) == true);
    ...
    delete [] l_x_raw;
    delete [] l_y_noedgecases;
    delete [] l_y_noedgecases_tiling;
}
