...
constexpr std::size_t OBJ_COLS =   1024;
constexpr std::size_t OBJ_ROWS =   1024;
constexpr std::size_t OBJ_LEVELS = 1024;
...
int main(int argc, char *argv[])
{
    ...
    routine<CLinearStencilNoedgecases, VALUE_TYPE, VEC_TYPE>(
        l_objCols,
        l_objRows,
        l_objLevels
    );
