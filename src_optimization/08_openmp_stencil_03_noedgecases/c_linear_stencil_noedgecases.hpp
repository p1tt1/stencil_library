...
class CLinearStencilNoedgecases : public ILinearOperator<ValueType>
{
 private:
 ...
 public:
    CLinearStencilNoedgecases(
      ...
      inline static const std::string IDENTIFER = "linear_stencil_noedgecases";
    void apply(const ValueType * __restrict__ p_x, ValueType * __restrict__ p_y) const;
    ~CLinearStencilNoedgecases();
};

template <typename ValueType, typename VecType>
CLinearStencilNoedgecases<ValueType, VecType>::CLinearStencilNoedgecases(
   const std::size_t p_objCols,
   const std::size_t p_objRows,
   const std::size_t p_objLevels,
   const ValueType p_c,
...
template <typename ValueType, typename VecType>
void CLinearStencilNoedgecases<ValueType, VecType>::apply(const ValueType * __restrict__ p_x, ValueType * __restrict__ p_y) const
{
   std::size_t l_pos;
