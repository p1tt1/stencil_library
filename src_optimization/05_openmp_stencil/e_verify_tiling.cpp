...
constexpr std::size_t OBJ_ROWS_TILING = 32;
constexpr std::size_t OBJ_LEVELS_TILING = 32;

constexpr std::size_t S_CUBE_SIZE_INNER = 2048;
constexpr std::size_t S_CUBE_SIZE = S_CUBE_SIZE_INNER + 2;
...
#include "c_linear_stencil_seq_tiling.hpp"
...
int main()
{
    ...
    assert(S_CUBE_SIZE_INNER%OBJ_COLS_TILING == 0);
    assert(S_CUBE_SIZE_INNER%OBJ_ROWS_TILING == 0);
    assert(S_CUBE_SIZE_INNER%OBJ_LEVELS_TILING == 0);
    ...
    VALUE_TYPE *l_vY_linear_stencil_seq_tiling = new VALUE_TYPE[OBJ_CELLS];
    VALUE_TYPE *l_vY_linear_stencil_para_tiling = new VALUE_TYPE[OBJ_CELLS];
    ...
    for (std::size_t i = 0; i < OBJ_CELLS; ++i)
    {
        ...
        // l_vY_linear_stencil_seq_tiling[i] = 0;
        // l_vY_linear_stencil_para_tiling[i] = 0;
    }
    ...
    std::cout << std::endl;
    std::cout << "> c_linear_stencil_seq_tiling.apply()" << std::endl;
    CLinearStencilSeqTiling<VALUE_TYPE,VEC_TYPE> l_linear_stencil_seq_tiling(
        OBJ_COLS,
        OBJ_ROWS,
        OBJ_LEVELS,
        OBJ_COLS_TILING,
    ...
    l_linear_stencil_seq_tiling.apply(l_vX,l_vY_linear_stencil_seq_tiling);

    // -------------------------------------------------------------------------------------------------

    std::cout << std::endl;
    std::cout << "> c_linear_stencil_para_tiling.apply()" << std::endl;
    CLinearStencilParaTiling<VALUE_TYPE,VEC_TYPE> l_linear_stencil_para_tiling(
        OBJ_COLS,
        OBJ_ROWS,
        OBJ_LEVELS,
        OBJ_COLS_TILING,
    ...
    l_linear_stencil_para_tiling.apply(l_vX,l_vY_linear_stencil_para_tiling);
    ...
    std::cout << std::endl;
    std::cout << "> compare l_vY_linear_stencil_seq_tiling with l_vY_linear_stencil_para_tiling" << std::endl;
    assert(equal(l_vY_linear_stencil_seq_tiling, l_vY_linear_stencil_para_tiling) == true);
    ...
    delete [] l_vX;
    delete [] l_vY_linear_stencil_seq_tiling;
    delete [] l_vY_linear_stencil_para_tiling;
}
