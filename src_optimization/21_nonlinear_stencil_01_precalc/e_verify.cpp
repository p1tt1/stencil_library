...
#include "c_nonlinear_stencil_precalc_01.hpp"
...
int main()
{
    ...
    VALUE_TYPE *l_y_nonlinear_recalc_01 = new VALUE_TYPE[OBJ_CELLS];
    ...
    std::cout << std::endl;
    std::cout << "> nonlinear_recalc_01:apply()" << std::endl;

    CNonlinearStencilPrecalc_01<CStateFunctionNone,VALUE_TYPE,VEC_TYPE> l_nonlinear_recalc_01(
        OBJ_COLS,
        OBJ_ROWS,
        OBJ_LEVELS,
        l_c,
    ...
    l_nonlinear_recalc_01.apply(l_x,l_y_nonlinear_recalc_01);
    ...
    std::cout << std::endl;
    std::cout << "> compare l_y_current with l_y_nonlinear_recalc_01" << std::endl;
    assert(equal(l_y_current, l_y_nonlinear_recalc_01) == true);
    ...
    delete [] l_y_nonlinear_recalc_01;
    delete [] l_c_raw;
}
