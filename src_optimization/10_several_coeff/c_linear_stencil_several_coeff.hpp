...
class CLinearStencilSeveralCoeff : public ILinearOperator<ValueType>
{
 private:
 ...
 public:
    CLinearStencilSeveralCoeff(
      ...
      inline static const std::string IDENTIFER = "several_coeff";
    void apply(const ValueType * __restrict__ p_x, ValueType * __restrict__ p_y) const;
    ~CLinearStencilSeveralCoeff();
};

template <typename ValueType, typename VecType>
CLinearStencilSeveralCoeff<ValueType, VecType>::CLinearStencilSeveralCoeff(
   const std::size_t p_objCols,
   const std::size_t p_objRows,
   const std::size_t p_objLevels,
   ValueType * p_c,
...
template <typename ValueType, typename VecType>
void CLinearStencilSeveralCoeff<ValueType, VecType>::apply(const ValueType * __restrict__ p_x, ValueType * __restrict__ p_y) const
{
   std::size_t l_pos;
