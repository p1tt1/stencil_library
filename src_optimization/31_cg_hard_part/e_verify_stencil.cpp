...
int main()
{
    ...
    std::cout << std::endl;
    std::cout << "> l_stencil_00::apply()" << std::endl;
    CStencil<VALUE_TYPE,VEC_TYPE> l_stencil_00(
        OBJ_COLS,
        OBJ_ROWS,
        OBJ_LEVELS,
        C,
    ...
    VALUE_TYPE *l_y_00 = new VALUE_TYPE[OBJ_CELLS];

    l_stencil_00.apply(l_x,l_y_00);

    // -------------------------------------------------------------------------------------------------

    std::cout << std::endl;
    std::cout << "> l_stencil_hard_part::apply()" << std::endl;
    ...
    VALUE_TYPE *l_y_hard_part = new VALUE_TYPE[OBJ_CELLS];

    l_stencil_hard_part.apply(l_x,l_y_hard_part);
    ...
    std::cout << std::endl;
    std::cout << "> compare l_y_00 with l_y_hard_part" << std::endl;
    assert(equal(l_y_00, l_y_hard_part) == true);
