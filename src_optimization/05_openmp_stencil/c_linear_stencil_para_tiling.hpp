...
class CLinearStencilParaTiling : public ILinearOperator<ValueType>
{
 private:
 ...
 public:
    CLinearStencilParaTiling(
      ...
      inline static const std::string IDENTIFER = "linear_stencil_para_tiling";
    void apply(const ValueType * __restrict__ p_x, ValueType * __restrict__ p_y) const;
    ~CLinearStencilParaTiling();
};

template <typename ValueType, typename VecType>
CLinearStencilParaTiling<ValueType, VecType>::CLinearStencilParaTiling(
   const std::size_t p_objCols,
   const std::size_t p_objRows,
   const std::size_t p_objLevels,
   const std::size_t p_objCols_tiling,
...
template <typename ValueType, typename VecType>
void CLinearStencilParaTiling<ValueType, VecType>::apply(const ValueType * __restrict__ p_x, ValueType * __restrict__ p_y) const
{
   //---------------------------------------------------------------
   // Notes: corners
   //---------------------------------------------------------------
