...
class CLinearStencilSeqTiling : public ILinearOperator<ValueType>
{
 private:
 ...
 public:
    CLinearStencilSeqTiling(
      ...
      inline static const std::string IDENTIFER = "linear_stencil_seq_tiling";
    void apply(const ValueType * __restrict__ p_x, ValueType * __restrict__ p_y) const;
    ~CLinearStencilSeqTiling();
};

template <typename ValueType, typename VecType>
CLinearStencilSeqTiling<ValueType, VecType>::CLinearStencilSeqTiling(
   const std::size_t p_objCols,
   const std::size_t p_objRows,
   const std::size_t p_objLevels,
   const std::size_t p_objCols_tiling,
...
template <typename ValueType, typename VecType>
void CLinearStencilSeqTiling<ValueType, VecType>::apply(const ValueType * __restrict__ p_x, ValueType * __restrict__ p_y) const
{
   VecType l_x_LL_Vec;
   VecType l_x_RL_Vec;
   VecType l_x_CL_Vec;
