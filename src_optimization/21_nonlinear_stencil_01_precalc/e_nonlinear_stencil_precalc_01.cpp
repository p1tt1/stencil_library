...
template <template<template<typename VecType> class StateFunction, typename ValueType, typename VecType> class OperatorType, template<typename ValueType> class StateFunction, typename ValueType, typename VecType>
...
int main(int argc, char *argv[])
{
    ...
    routine<CNonlinearStencilPrecalc_01, CStateFunctionMul2, VALUE_TYPE, VEC_TYPE>(
        l_objCols,
        l_objRows,
        l_objLevels
    );
