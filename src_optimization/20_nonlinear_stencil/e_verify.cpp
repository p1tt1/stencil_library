...
int main()
{
    ...
    CNonlinearStencil<SSF_none,VALUE_TYPE,VEC_TYPE> l_nonlinear(
    // CNonlinearStencil<SSF_mul2,VALUE_TYPE,VEC_TYPE> l_nonlinear(
        OBJ_COLS,
        OBJ_ROWS,
        OBJ_LEVELS,
        l_c,
    ...
    std::cout << std::endl;
    std::cout << "> compare l_y_current with l_y_nonlinear_01" << std::endl;
    assert(equal(l_y_current, l_y_nonlinear_01) == true);
