...
APP_PATH=${1:-./e_nonlinear_stencil_precalc}
...
for INDEX in ${!THREAD_LIST[@]}; do
  ...
  CURRENT_CMD="$APP_PATH $OBJ_COLS $OBJ_ROWS $OBJ_LEVELS"
  ...
  output "$NODE_ID,$SCRIPT_ID,$IMPL_ID,$REGION_ID_APPLY,$OBJ_COLS_RESULT,$OBJ_ROWS_RESULT,$OBJ_LEVELS_RESULT,$THREADS,$RUNTIME_APPLY,$EFFICIENCY_APPLY"
  output "$NODE_ID,$SCRIPT_ID,$IMPL_ID,$REGION_ID_ROUTINE,$OBJ_COLS_RESULT,$OBJ_ROWS_RESULT,$OBJ_LEVELS_RESULT,$THREADS,$RUNTIME_ROUTINE,$EFFICIENCY_ROUTINE"
