...
class CLinearStencilVCL : public ILinearOperator<ValueType>
{
 private:
 ...
 public:
    CLinearStencilVCL(
      ...
      inline static const std::string IDENTIFER = "linear_stencil_vcl";
    void apply(const ValueType * __restrict__ p_x, ValueType * __restrict__ p_y) const;
    ~CLinearStencilVCL();
};

template <typename ValueType, typename VecType>
CLinearStencilVCL<ValueType, VecType>::CLinearStencilVCL(
   const std::size_t p_objCols,
   const std::size_t p_objRows,
   const std::size_t p_objLevels,
   const ValueType p_c,
...
template <typename ValueType, typename VecType>
void CLinearStencilVCL<ValueType, VecType>::apply(const ValueType * __restrict__ p_x, ValueType * __restrict__ p_y) const
{
   VecType l_x_LL_Vec;
   VecType l_x_RL_Vec;
   VecType l_x_CL_Vec;
