...
constexpr std::size_t ITER_SOLVER_MAX = 100000;
constexpr std::size_t ITER_STEP_CALC_MAX = 1000;

constexpr VALUE_TYPE EPSILON_OPERATOR = 1e-100;
constexpr VALUE_TYPE EPSILON_SOLVER = 1e-10;
constexpr VALUE_TYPE EPSILON_STEP_CALC = 1e-10;
...
)
{
    ...
    std::cout << "IMPL_ID_IMPL," << "cg_nonlinear" << std::endl;
