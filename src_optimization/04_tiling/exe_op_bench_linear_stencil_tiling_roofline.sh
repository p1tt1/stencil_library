...
ALGORTIHM_ID="linear_stencil_tiling"
...
CMD_MEM="$CMD_BENCH_PREFIX_MEM $OBJ_COLS $OBJ_ROWS $OBJ_LEVELS $TILING_COLS $TILING_ROWS $TILING_LEVELS"
# CMD_MEM="$CMD_BENCH_PREFIX_MEM 8 8 8 4 4 4"
...
CMD_FLOPS_DP="$CMD_BENCH_PREFIX_FLOPS_DP $OBJ_COLS $OBJ_ROWS $OBJ_LEVELS $TILING_COLS $TILING_ROWS $TILING_LEVELS"
# CMD_FLOPS_DP="$CMD_BENCH_PREFIX_FLOPS_DP 8 8 8 4 4 4"
