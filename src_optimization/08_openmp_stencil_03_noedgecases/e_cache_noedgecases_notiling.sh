...
APP_PATH=${1:-./e_linear_stencil_noedgecases_likwid}
...
bench_cmd(){
  ...
  echo "likwid-perfctr -C $(thread_config $1) -f -g CACHE -m $APP_PATH"
}
...
CURRENT_CMD="$(bench_cmd $THREADS) $OBJ_COLS $OBJ_LEVELS_ROWS $OBJ_LEVELS_ROWS"
