...
TILINGS_LEVELS_ROWS=0

OMP_NUM_THREADS=16
OMP_PLACES=threads
OMP_PROC_BIND=spread

APP_PATH=${1:-./e_linear_stencil_noedgecases}
...
CURRENT_CMD="$APP_PATH $OBJ_COLS $OBJ_LEVELS_ROWS $OBJ_LEVELS_ROWS"

log_everywhere_silent "\$ $CURRENT_CMD"
...
for TILING_COLS in ${TILINGS_COLS[@]}; do
  ...
  output "$NODE_ID,$BENCH_ID,$IMPL_ID,$REGION_ID_APPLY,$OMP_NUM_THREADS,$OBJ_COLS_RESULT,$OBJ_ROWS_RESULT,$OBJ_LEVELS_RESULT,$TILING_COLS,$TILINGS_LEVELS_ROWS,$TILINGS_LEVELS_ROWS,$RUNTIME_APPLY"
  output "$NODE_ID,$BENCH_ID,$IMPL_ID,$REGION_ID_ROUTINE,$OMP_NUM_THREADS,$OBJ_COLS_RESULT,$OBJ_ROWS_RESULT,$OBJ_LEVELS_RESULT,$TILING_COLS,$TILINGS_LEVELS_ROWS,$TILINGS_LEVELS_ROWS,$RUNTIME_ROUTINE"
