...
class CLinearStencilSeq : public ILinearOperator<ValueType>
{
 private:
 ...
 public:
    CLinearStencilSeq(
      ...
      inline static const std::string IDENTIFER = "linear_stencil_seq";
    void apply(const ValueType * __restrict__ p_x, ValueType * __restrict__ p_y) const;
    ~CLinearStencilSeq();
};

template <typename ValueType, typename VecType>
CLinearStencilSeq<ValueType, VecType>::CLinearStencilSeq(
   const std::size_t p_objCols,
   const std::size_t p_objRows,
   const std::size_t p_objLevels,
   const ValueType p_c,
...
template <typename ValueType, typename VecType>
void CLinearStencilSeq<ValueType, VecType>::apply(const ValueType * __restrict__ p_x, ValueType * __restrict__ p_y) const
{
   VecType l_x_LL_Vec;
   VecType l_x_RL_Vec;
   VecType l_x_CL_Vec;
