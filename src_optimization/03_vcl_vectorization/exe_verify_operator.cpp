...
constexpr std::size_t S_COLS =   S_CUBE_SIZE;
constexpr std::size_t S_ROWS =   S_CUBE_SIZE;
constexpr std::size_t S_LEVELS = S_CUBE_SIZE;
...
int main()
{
    ...
    VALUE_TYPE *l_vY_linear_stencil_vcl = new VALUE_TYPE[S_CELLS];
    ...
    std::cout << std::endl;
    std::cout << "> c_linear_stencil_vcl.apply()" << std::endl;
    CLinearStencilVCL<VALUE_TYPE,VEC_TYPE> l_linear_stencil_vcl(
        S_COLS,
        S_ROWS,
        S_LEVELS,
        C,
    ...
    l_linear_stencil_vcl.apply(l_vX,l_vY_linear_stencil_vcl);
    ...
    std::cout << std::endl;
    std::cout << "> compare l_vY_linear_stencil with l_vY_linear_stencil_vcl" << std::endl;
    assert(equal(l_vY_linear_stencil, l_vY_linear_stencil_vcl) == true);
    ...
    delete [] l_vY_linear_stencil_vcl;
}
